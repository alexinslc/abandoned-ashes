 ...
 * @prop {Record<'base'|'ansi'|'brightOther'|'other', string[]>} abandedashes - AbandonedAshes color variables.
...
const transformSoft = (yamlContent, yamlObj) => {
    const brightColors = [
        ...yamlObj.abandonedashes.ansi,
        ...yamlObj.abandonedashes.brightOther,
    ];
    return load(
...
module.exports = async () => {
    const yamlFile = await readFile(
        join(__dirname, '..', 'src', 'abandoned-ashes.yml'),
        'utf-8'
    );
